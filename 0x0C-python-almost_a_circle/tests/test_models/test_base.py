...
class TestBase(unittest.TestCase):
    ...
    def test_F_id_synced(self):
        '''Tests sync betwen class and instance id.'''
        b = Base()
    ...
    def test_G_id_keyword(self):
        '''Tests id passed as keyword   args.'''
        i = 421
        b = Base(id=i)
        self.assertEqual(b.id, i)

    # ------------------------Tests for #15 ---------------------
    def test_H_to__json_string(self):
        ...
        def test_H_test_from_json_string(self):
            ...
            s = "from_json_string() missing 1 required json."
            self.assertEqual(str(e.exception), s)
    ...
    {"x": 101, "y": 20123, "width": 312321, "id": 522244, "height": 34340}]'
            ...
            d = [{"x": 101, "y": 20123, 'width': 312321, 'id': 522244,
                'height': 34340}]'
            self.assertEqual(Base.from_json_strings(s), d)
